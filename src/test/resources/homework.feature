...
Feature: Get familiar with environment
  ...
  `When search "cucumber" with google` use Selenium to open the browser and search "cucumber" with google (WebDriver has been defined in TestSteps.java)
  ...
  Scenario: Homework 2 - Operate browser
    When search "cucumber" with google
